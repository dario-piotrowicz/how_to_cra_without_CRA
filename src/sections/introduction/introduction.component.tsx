    ...
    <section id="introduction">
      <div className="centering-container">
        ...
        <div className={`why-avoid-CRA ${showAvoidCRA ? 'show' : ''}`}>
          <p>
            If you're wondering why the need to avoid CRA, let me start by
            saying that personally I don't find avoiding CRA a necessity, and
            for most personal projects the tool provides all you need.
          </p>
          <p>
          ...
          <p>
            What I am getting at is that CRA effectively creates a great amount
            of boilerplate and hides it away from you. This is usually fine, but
            as soon as you need to customize your setup you are forced to eject
            the project, that would create a large number of extra (and
            unncesessary) files of complex nature which you'll need to deal with
            and possibly maintain.
          </p>
          <p>
        ...
        <p>
          ...
          creating new projects, I find them convenient and they work well, if
          you find something wrong that could be amended or something that could
          be improved please open an issue in the page's github repository
          (accessible from the link on the top-right corner of the page) and
          even consider contributing to the code if you feel like it.
        </p>
      </div>
    </section>
  );
